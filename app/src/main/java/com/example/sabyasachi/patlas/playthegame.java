...
public class playthegame extends ActionBarActivity {

    SqlLiteDbHelper dbHelper;
    private Cursor cursor;
    SQLiteDatabase relief;
    Contact contacts ;
    static int foo = 0,c=1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_playthegame);
        EditText et1_input;
        et1_input = (EditText)findViewById(R.id.editText5);
        ...
        tv2_text = (TextView)findViewById(R.id.editText4);
        tv4_text = (TextView)findViewById(R.id.textView6);
        tv6_text = (TextView)findViewById(R.id.editText3);
        et1_input = (EditText)findViewById(R.id.editText5);
        high_score = (TextView)findViewById(R.id.textView11);

        final EditText finalEt1_input = et1_input;
        ...
        if( level != 1) {
            ...
            if ( level == 3)
                time = 15000;
            final TextView mTextField = (TextView) findViewById(R.id.textView7);
            tk = new CountDownTimer(time, 1000) {
                ...
                public void onFinish() {
                    ...
                    Intent i = new Intent(playthegame.this, earthcry.class);
                    startActivity(i);
                }
            }.start();
        }
    ...
    public void onClickGo(){
        ...
        else if (contacts.id ==-1 || contacts.id ==-2 )
        {
            ...
            if ( sendsql.equals("WON") == true) {
                Intent i = new Intent(playthegame.this,Maps.class);
                startActivity(i);
            }
            l1 = sendsql.length();
    ...
    public void onBackPressed() {
        ...
        String mode = "easy";
        dbHelper.put_user(name, score, sex, mode);
        Intent intent = new Intent(playthegame.this,newconhigh.class);
    ...
    public void OnClickHelp(View view)
    {
        ...
        editor.putInt("Last_score", foo);
        editor.commit();
        Intent i = new Intent(playthegame.this,help.class);
        startActivity(i);
    }
